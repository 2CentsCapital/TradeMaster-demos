...
if __name__ == '__main__':
    ...
    '''
    Thereafter, to find the optimal parameter combination for the strategy, use the optimize_stock
    function. Provide stock, timeframe, market and exchange(optional) as arguments.
    ...
    The output is a summary excel sheet.
    ...
    '''
    bt.optimize_stock('AAPL', '1day', 'us', 'firstratedata', 
    constraint=sma_constraint, sma_short = range(10,100,10), sma_long = range(40,150,10))
