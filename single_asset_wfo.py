...
if __name__ == '__main__':
    ...
    '''
    Thereafter, to optimise on a single stock, specify the stock name, timeframe, market name and the exchange name.
    ...
    1. The summary of the optimization.
    2. The tearsheet. 
    '''
    optimizer.optimize_stock('A', '1day', 'us', 'firstratedata', '6M', '2M')
