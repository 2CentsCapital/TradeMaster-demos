...
if __name__ == '__main__':    
    ...
    '''
    Thereafter, to backtest for all stocks in a universe for all timeframes, specify the universe name, 
    timeframe = 'all' and the exchange name.
    ...
    1. The summary of the run for the universe, in an excel sheet. There will be a subsheet for each timeframe
       for which data exists in the db.
    2. All tearsheets present within a subdirectory named output_tearsheets
    '''
    bt.backtest_universe('S&P 500', 'all', 'firstratedata')
