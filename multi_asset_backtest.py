...
if __name__ == '__main__':    
    ...
    '''
    Thereafter, to backtest for all stocks in a universe, specify the universe name, timeframe and the exchange name.
    ...
    1. The summary of the run for the universe, in an excel sheet.
    2. All tearsheets present within a subdirectory named output_tearsheets
    '''
    bt.backtest_universe('S&P 500', '1day', 'firstratedata')
