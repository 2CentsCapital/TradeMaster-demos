...
if __name__ == '__main__':
    ...
    '''
    Thereafter, to backtest a single stock, specify the stock name, timeframe, market name, exchange name
    ...
    1. The stats of the run. These will be returned from the function call and can be used so forth.
    2. The tearsheet. This is saved and the path is printed in the output. Refer to this path.
    '''
    stats = bt.backtest_stock("AAPL", "1day", "us", "firstratedata")
    print(stats)
